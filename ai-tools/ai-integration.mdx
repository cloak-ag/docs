...
Implement a minimal Cloak integration for a simple SOL send flow using `@cloak.ag/sdk`.
...
5) Never log secrets (private keys, viewing keys, signatures, raw note secrets).
