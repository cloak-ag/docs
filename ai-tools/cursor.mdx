...
- Circuit base URL: `https://storage.googleapis.com/cloak-circuits/circuits/0.2.0` (prefer the exported `DEFAULT_CIRCUITS_URL` constant over hardcoding the string)
