...
- Circuit base URL: `https://storage.googleapis.com/cloak-circuits/circuits/0.2.0` (ceremony bundle; the SDK default via `resolveCircuitsBase()` — never hand-write it, and never use `0.1.0`: the program no longer accepts those artifacts)
