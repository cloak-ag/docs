...
description: "Current registration, trust model, chain-native scanning, and web cache behavior"
icon: "key"
---

Sources:

- `services/relay/src/api/viewing_key.rs`
- `sdk/src/core/transact.ts`
- `sdk/src/core/scanner.ts`
- `web/hooks/use-cloak-sdk.ts`
- `web/lib/compliance-cache.ts`
- `web/components/encryption-provider.tsx`
