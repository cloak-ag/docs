...
<CardGroup cols={2}>
  ...
  <Card title="Tax reporting" icon="FileText">
  ...
  <Card title="Disputes" icon="Scale">
...
<CardGroup cols={2}>
  ...
  <Card title="Prove your funds privately" icon="FileBadge" href="/learn/prove-your-funds-privately">
