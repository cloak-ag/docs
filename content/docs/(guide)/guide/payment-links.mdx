...
<img
  src="/images/payment-link-flow.svg"
  alt="Sending with a link: you shield funds into the pool, share the link off-chain, and whoever holds it claims from the pool — the two wallets never touch on-chain"
...
<img
  src="/images/payment-link-request-flow.svg"
  alt="Requesting with a link: you ask off-chain, the payer funds a link and sends it back off-chain, and you claim from the pool — your address never reaches them"
  style={{ width: "100%", borderRadius: 12, border: "1px solid var(--color-fd-border)" }}
/>
