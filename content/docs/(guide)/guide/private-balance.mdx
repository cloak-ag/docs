...
<CardGroup cols={3}>
  ...
  <Card title="Backup file" icon="FileLock">
...
<CardGroup cols={2}>
  <Card title="Security and threat model" icon="ShieldHalf" href="/guide/security">
    What Cloak cannot do, on-chain protections, and who can see what.
  </Card>
  <Card title="FAQ" icon="CircleQuestionMark" href="/guide/faq">
