...
Cloak's shield-pool program has undergone an external security assessment. The full report is being prepared for publication and will be linked here. {/* TODO(audit-url): link the published audit report */} Our full threat model — including what Cloak cannot do — is at [Security](/guide/security).
</Accordion>
