...
Getting in is free, and staying in is free. Leaving costs 0.3% plus a fixed fee: 0.005 SOL for SOL, 0.45 tokens for USDC and USDT.
...
<Tip>
  Other Solana privacy protocols charge a flat 1% on every withdrawal. Cloak charges 0.3% plus a fixed fee of 0.005 SOL (SOL) or 0.45 tokens (USDC/USDT).
</Tip>
...
**Send 100 USDC.** The recipient receives exactly 100 USDC. The fee is 0.45 USDC fixed + 0.30 USDC (0.3% of 100), so your private balance decreases by 100.75 USDC.
