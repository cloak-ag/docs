...
Getting in is free, and staying in is free. Leaving costs 0.3% — plus a small fixed fee: 0.005 SOL when what's leaving is SOL, 0.45 USDC or USDT when it's a stablecoin.
...
<Tip>
  Other Solana privacy protocols charge a flat 1% on every withdrawal. Cloak charges 0.3% — plus a fixed 0.005 SOL for SOL, or 0.45 USDC/USDT for stablecoins.
</Tip>
