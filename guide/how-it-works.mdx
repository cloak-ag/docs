...
- Minimum 0.01 SOL for SOL; 1.00 USDC or 1.00 USDT for stablecoins.
...
Holding the tokens on another chain instead? [Bridging in](/guide/bridge) takes USDC from Polygon, Ethereum, Base, Arbitrum, or Sui and lands it straight in your private balance, without a Solana wallet of yours in the middle.
