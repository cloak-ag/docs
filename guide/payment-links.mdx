...
<img
  ...
  alt="Payment link flow: you shield funds into the pool, share the link off-chain, and whoever holds it claims from the pool — the two wallets never touch on-chain"
