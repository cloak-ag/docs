...
| [Bridge in](/guide/bridge) from another chain | USDC in, USDC out — it lands in your USDC private balance |
| Payroll | USDC, USDT |
...
The two routes cover different chains, and they differ in more than coverage — one signs its deposit address and refunds an order it cannot fill, the other does neither. [Bridge routes and what each one guarantees](/guide/bridge-routes) is the comparison.
...
| Shield USDC or USDT | 1.00 USDC / 1.00 USDT |
| Bridge in | the route's own minimum, plus enough to clear the 1.00 USDC shield minimum after costs — the app refuses a quote it could not shield, before showing you an address |
