...
- `cloak-mixer` automates deposit/withdraw cycles against program + relay
- Uses local SQLite state for indexed deposits and recoverability
...
5. [Cloak Mixer Bot](/bots/cloak-mixer)
