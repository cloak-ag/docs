...
- SOL total fee: `5_000_000 + floor(gross * 3 / 1000)`
- SPL total fee: `ceil(0.005 SOL converted by token/SOL Q64.64 quote) + floor(gross * 3 / 1000)`
...
- Accept submit requests (`/transact`, `/transact_swap`, `/withdraw`)
...
- Serve risk quote endpoint (`/range-quote`)
