...
Full flow guide: [UTXO Transactions](/sdk/utxo-transactions.mdx)
...
- `RelayService` methods and UTXO helpers share the same relay orchestration surface with different payload shapes.
...
- [Shield Pool Program](/protocol/shield-pool.mdx)
- [Transaction Flows](/platform/transaction-flows.mdx)
- [Code Examples](/sdk/examples.mdx)
