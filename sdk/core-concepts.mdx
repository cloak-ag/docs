...
- `fee` = `450_000` base units fixed (0.45 USDC/USDT) + `gross * 3 / 1000`, charged in the withdrawn token

Minimum deposit: `10_000_000` lamports (`0.01 SOL`) on the SOL pool; `1_000_000` base units
(`1.00`) on the USDC and USDT pools. See [Fee Model](/protocol/fee-model).
