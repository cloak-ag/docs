...
- Relay-managed submit and status lifecycle
...
- UTXO details: [UTXO Transactions](/sdk/utxo-transactions.mdx)
- Protocol rules: [Shield Pool Program](/protocol/shield-pool.mdx)
- Runtime flow: [Transaction Flows](/platform/transaction-flows.mdx)
