...
- `fee` = `gross * 3 / 1000` only — no fixed component, charged in the withdrawn token

Minimum deposit: `10_000_000` lamports (`0.01 SOL`, SOL pool only). See [Fee Model](/protocol/fee-model).
