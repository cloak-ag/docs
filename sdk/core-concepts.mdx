...
The SDK computes proofs automatically during withdrawal:

```typescript
// SDK handles this internally
const proof = await sdk.getMerkleProof(note.leafIndex);
```
...
With view keys, you can scan the blockchain for incoming notes:

```typescript
const sdk = new CloakSDK({
  keypairBytes: keypair.secretKey,
  cloakKeys: keys, // Enable scanning
  network: "devnet",
});

// Scan for notes belonging to this wallet
