...
export async function handleCloakError(
  ...
  switch (error.category) {
    ...
    case "indexer":
      // Note: The SDK no longer uses an indexer for proofs (computed on-chain)
      // This category is kept for backwards compatibility
      showMessage("Service error: " + error.message);
      return false;
