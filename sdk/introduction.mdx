...
|---------|--------|------------|
| Mainnet | ✅ Live | `c1oak6tetxYnNfvXKFkpn1d98FxtK7B68vBQLYQpWKp` (default) |
| Devnet | ✅ Live | `3EvH6XYQir7D2RyzCdP7QFmJFfSPfdeoB8VnpLdEF4Kr` |
| Localnet | ✅ Supported | Deploy your own |

<Warning>
**Critical for Devnet**: You MUST explicitly set the `programId` when using devnet. The SDK defaults to mainnet's program ID, which will cause `0x1001 RootNotFound` errors on devnet.
