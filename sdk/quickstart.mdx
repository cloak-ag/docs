...
This guide walks you through depositing SOL into the Cloak privacy pool and withdrawing to a recipient privately.

<Info>
**What you'll build:** A script that deposits 0.01 SOL, then withdraws it to a recipient with full transaction privacy.
</Info>
...
<Card title="Solana keypair" icon="key">
With devnet SOL
</Card>
...
<Note>
The sum of all recipient amounts must equal `getDistributableAmount(note.amount)` (deposit amount minus 0.005 SOL fixed fee and 0.3% variable fee).
</Note>
