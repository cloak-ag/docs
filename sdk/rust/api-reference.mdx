...
See [Error handling](/sdk/rust/error-handling.mdx) for retry semantics.
...
- [Quickstart](/sdk/rust/quickstart.mdx) — end-to-end SOL deposit
- [Core concepts](/sdk/rust/core-concepts.mdx) — how types map to protocol primitives
- [Error handling](/sdk/rust/error-handling.mdx) — retry + classification
- [Protocol architecture](/protocol/architecture.mdx) — what the SDK is targeting on-chain
