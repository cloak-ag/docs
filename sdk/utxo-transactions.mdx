...
- SOL withdraw/swap:
  ...
  - `net = gross - fee`
- SPL withdraw:
  - `fixed_token = ceil(0.005 SOL converted using token/SOL Q64.64 quote)`
...
- SPL: `calculateSplFeeTokenAmount`, `calculateSplNetAmountToken`
...
Relay serves `GET /range-quote`; you can use that route or provide your own quote backend/direct instruction callback.
