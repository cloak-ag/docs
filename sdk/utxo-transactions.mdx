...
- Deposits and shielded transfers have no protocol fee; SOL deposits must satisfy the
  min deposit (`10_000_000` lamports — SOL pool only, no program minimum for SPL)
