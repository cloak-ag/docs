...
If your app standardizes on `@solana/kit`, add it as well and use the bridge pattern in [Solana Kit Integration](/sdk/kit-integration.mdx).
...
- [Quickstart](/sdk/quickstart.mdx)
- [UTXO Transactions](/sdk/utxo-transactions.mdx)
- [Error Handling](/sdk/error-handling.mdx)
