...
This page documents only the relay endpoints used by SDK/web runtime flows.

For the complete relay route surface (admin/internal/ops), use `services/relay/` as source of truth.
...
Not part of normal SDK happy-path:

- `GET /risk-quote` in this relay build returns `501 Not Implemented`
...
This page intentionally excludes admin/internal relay routes.

If you need full relay route coverage, document and maintain it under `services/relay/` only.
