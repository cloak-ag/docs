...
This page documents relay endpoints used by SDK-powered applications.
...
Returns commitments for Merkle rebuild:
...
If Merkle tree data is temporarily unavailable, endpoint returns `503`.
